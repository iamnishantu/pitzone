...
// exports.userRegister = async(payload)=>{
// 	try{
...
// 		    return{
// 			status:400,
// 			message:`User Allready Registerd with${payload.phone_number}`
// 	     }
// 	    }
// 	if(!user){
...
// 			success:true,
// 			data:result,
// 			message:'Uesr Register successfully',
...
// 	}
//  }
exports.userRegister = async (phoneNumber, name, password) => {
